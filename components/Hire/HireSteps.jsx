        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-10">
          ...
          <div>
            ...
            <div className="bg-technology p-10 lg:ml-8 mb-4">
              ...
              <p className="Gilroy-Light text-lg opacity-60 pt-2">
              Once you find your right-fit talent, we’ll help you remotely onboard, begin the project, and provide support. Hire Android app developer from our company to get the best-in-class projects.
              </p>
            </div>
          </div>
        </div>
